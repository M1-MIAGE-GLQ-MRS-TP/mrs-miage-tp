 ...
 * - Méthodes statiques partout
 * - Messages d'erreur en dur dans plusieurs langues mélangées
 * - Regex compilées à chaque appel (performance)
 * - Validation dispersée (devrait être dans les objets métier)
 */
public class ValidationUtils {
     ...
     * Problème : regex basique, ne vérifie pas vraiment le format
     */
     ...
     * Problème : ne vérifie pas le checksum
     */
     ...
     * Problème : format français uniquement, pas flexible
     */
     ...
     * Problème : valeur en dur, pas de contexte
     */
     ...
     * Problème : devrait être un enum, pas une validation de string
     */
     ...
     * Problème : message en dur, pas de i18n
     */
