 ...
 * - Utilisation de java.util.Date (obsolète)
 * - Méthodes statiques partout (difficile à tester/mocker)
 * - SimpleDateFormat non thread-safe utilisé en static
 * - Duplication de logique de calcul de jours
 * - Magic numbers
 */
public class DateUtils {
    
    // SimpleDateFormat n'est PAS thread-safe ! Problème en environnement concurrent
    private static SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
    private static SimpleDateFormat dateTimeFormat = new SimpleDateFormat("dd/MM/yyyy HH:mm");
    
    // Constantes en millisecondes (magic numbers moins magiques)
    ...
    public static Date parseDate(String dateStr) {
        ...
        try {
            ...
            // Avaler l'exception et retourner null (mauvaise pratique !)
            return null;
        }
    }
