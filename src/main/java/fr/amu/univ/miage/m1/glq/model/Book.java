 ...
 * - Setters publics partout (pas d'immutabilité)
 * - Pas de validation
 * - equals/hashCode manquants
 */
public class Book {
    ...
    // Constructeur par défaut (problème : permet des objets invalides)
    public Book() {
    }
    
    // Constructeur avec paramètres (trop de paramètres !)
    ...
    // Getters et setters basiques (pas de validation)
